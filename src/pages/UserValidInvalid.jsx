      ...
      <div className="w-lg max-w-lg py-8 sm:rounded-2xl sm:bg-white sm:px-12 sm:shadow">
        <div className="space-y-2 text-center">
          ...
          <p className="text-neutral-500">
            Pseudo classes - :user-valid :user-invalid
          </p>
        </div>
            ...
            <div className="form-group relative">
              ...
              <div className="input-wrapper-new">
                ...
                <input
                  ...
                  className="peer inputbox-new"
                />
                <p className="error-message-new">
            ...
            <div className="form-group relative">
              ...
              <div className="input-wrapper-new">
                ...
                <input
                  ...
                  className="peer inputbox-new"
                />
                <p className="error-message-new">Phone must be 10 digits</p>
              </div>
            </div>
...
export default UserValidInvalid;
